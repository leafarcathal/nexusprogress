...
{
		obj=document.getElementById(lastToggle);
...
var cellHighlightColor = "gray";	// Color for cell highlight
...
function compare(a, b)
{
	...
	// Remove HTML tags 
	reRowText = /(\< *[^\>]*\>|\&nbsp\;)/g;
	aRowContent[sortIndex] = aRowContent[sortIndex].replace(reRowText, "").replace(/,/g, "");
	bRowContent[sortIndex] = bRowContent[sortIndex].replace(reRowText, "").replace(/,/g, "");
